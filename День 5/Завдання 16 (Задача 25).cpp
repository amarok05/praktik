#include <algorithm>//заголовочный файл из стандартной библиотеки с++,включающий набор функций для выполнения алгоритмических операций над контейнерами и над другими последовательностями
#include <iostream>
